...
if  strcmp(mark, 'Ripple')
    HFOobj.maxAmplitudeFiltered = 300;  % max amplitude of ripple, artifact rejection, in muV
elseif strcmp(mark, 'FastRipple')
    HFOobj.maxAmplitudeFiltered = 200;  % max amplitude of FR, artifact rejection, in muV
end
% merge IoEs
