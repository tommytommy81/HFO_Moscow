...
switch pat
    ...
    data_dir = 'D:\Tom_Local\DATA\MOSCOW\Pirogov\Pirogov DATA\180122\nights\'
...
t1         = cputime;
[hdr,data] = edfread([data_dir filename],'targetSignals',1:119); % EEG
